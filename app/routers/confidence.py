...
@router.get(
    ...
    description=(
        ...
        "`S_TVL = max(0, min(1, log10(TVL/TVL_min) / log10(TVL_ref/TVL_min)))` "
        "(TVL_min=10 000, TVL_ref=1 000 000) and `S_slip = exp(−slip_1k / slip_max)`. "
        "For cross-rate branches: geometric mean of both legs' S_liq.\n"
